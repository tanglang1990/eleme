 ...
 */
;(function($){
    $('.index-shop-list li img').each(function (index,value) { 
    ...
    function meng(jDom,lazyLoadCoutn,callback){
        ...
        $(".content").append("<div class='meng-lazy-div"+lazyLoadCoutn+"' style='background-color: "+defaults.coverColor+";position:absolute;width:"+w+"px;height:"+h+"px;top:"+offsetTop+"px;left:"+offsetLeft+"px;z-index:500'>"+defaults.coverDiv+"</div>");
